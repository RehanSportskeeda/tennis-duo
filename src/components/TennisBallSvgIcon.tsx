...
interface TennisBallSvgIconProps {
  className?: string;
}

const TennisBallSvgIcon: React.FC<TennisBallSvgIconProps> = ({ className = "w-6 h-6" }) => {
  return (
    <svg 
      className={className}
      version="1.1" 
      ...
      style={{enableBackground:"new 0 0 2200 2200"}} 
      xmlSpace="preserve"
    >
      <g id="background">
...
export default TennisBallSvgIcon;